...
declare type PromptOptions = ArrayPromptOptions | BooleanPromptOptions | StringPromptOptions;
...
interface GeneratorConfig {
     ...
     */
    prompts?: PromptOptions[] | ((this: SAO, ctx: SAO) => PromptOptions[] | Promise<PromptOptions[]>);
    /**
...
declare type GroupedGenerators = Map<string, Array<NpmGenerator | RepoGenerator>>;
...
declare class SAO {
    ...
    spinner: Ora;
    colors: colors.Chalk & colors.ChalkFunction & {
     ...
     */
    getGenerator(generator?: ParsedGenerator, hasParent?: boolean): Promise<{
        generator: ParsedGenerator;
        config: GeneratorConfig;
    }>;
    runGenerator(generator: ParsedGenerator, config: GeneratorConfig): Promise<void>;
    run(): Promise<void>;
    /**
     * Retrive the answers
     *
...
export { GeneratorConfig, Options$1 as Options, SAO, generatorList, handleError, runCLI, store };
